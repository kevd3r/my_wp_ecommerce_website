...
"Please add a placeholder or select a default option." => array( null, __("Please add a placeholder or select a default option.", "forminator" ), ), // src/form/components/modals/settings.js:180
"Please, connect your Stripe account first!" => array( null, __("Please, connect your Stripe account first!", "forminator" ), ), // src/form/components/modals/settings.js:188
"You need at least one payment!" => array( null, __("You need at least one payment!", "forminator" ), ), // src/form/components/modals/settings.js:193
"Please select an email address for payment receipt." => array( null, __("Please select an email address for payment receipt.", "forminator" ), ), // src/form/components/modals/settings.js:198
"Empty labels are not allowed for meta values!" => array( null, __("Empty labels are not allowed for meta values!", "forminator" ), ), // src/form/components/modals/settings.js:207
"Please connect your PayPal account first!" => array( null, __("Please connect your PayPal account first!", "forminator" ), ), // src/form/components/modals/settings.js:218
"Please enter PayPal payment amount!" => array( null, __("Please enter PayPal payment amount!", "forminator" ), ), // src/form/components/modals/settings.js:223
"Please select PayPal payment variable field!" => array( null, __("Please select PayPal payment variable field!", "forminator" ), ), // src/form/components/modals/settings.js:228
"Calculation formula is required!" => array( null, __("Calculation formula is required!", "forminator" ), ), // src/form/components/modals/settings.js:236
"Limit Min value should be less than Max value." => array( null, __("Limit Min value should be less than Max value.", "forminator" ), ), // src/form/components/modals/settings.js:244
"Please enter API keys." => array( null, __("Please enter API keys.", "forminator" ), ), // src/form/components/modals/settings.js:251
"Please select a valid end time limit." => array( null, __("Please select a valid end time limit.", "forminator" ), ), // src/form/components/modals/settings.js:314
"Please fix the Default time error." => array( null, __("Please fix the Default time error.", "forminator" ), ), // src/form/components/modals/settings.js:317
"Please fix the Start or End time." => array( null, __("Please fix the Start or End time.", "forminator" ), ), // src/form/components/modals/settings.js:327
"Please fix the limit Start or End date." => array( null, __("Please fix the limit Start or End date.", "forminator" ), ), // src/form/components/modals/settings.js:424
"Calculations" => array( null, __("Calculations", "forminator" ), ), // src/form/components/modals/settings.js:555
"Styling" => array( null, __("Styling", "forminator" ), ), // src/form/components/modals/settings.js:575
"Customize" => array( null, __("Customize", "forminator" ), ), // src/form/components/modals/settings.js:585
"Visibility" => array( null, __("Visibility", "forminator" ), ), // src/form/components/modals/settings.js:595
...
"values can include letters, numbers, and hyphens only." => array( null, __("values can include letters, numbers, and hyphens only.", "forminator" ), ), // src/form/components/settings/multi-value.js:624
"Warning! You've added more than 1000 options. Switching back to the standard (non-bulk) editor could make your browser slow or unresponsive. Proceed with caution." => array( null, __("Warning! You've added more than 1000 options. Switching back to the standard (non-bulk) editor could make your browser slow or unresponsive. Proceed with caution.", "forminator" ), ), // src/form/components/settings/multi-value.js:627
"Options" => array( null, __("Options", "forminator" ), ), // src/form/components/settings/multi-value.js:632
"Enable Images" => array( null, __("Enable Images", "forminator" ), ), // src/form/components/settings/multi-value.js:649
"Bulk Edit" => array( null, __("Bulk Edit", "forminator" ), ), // src/form/components/settings/multi-value.js:659
"Loading" => array( null, __("Loading", "forminator" ), ), // src/form/components/settings/multi-value.js:670
"Add Option" => array( null, __("Add Option", "forminator" ), ), // src/form/components/settings/multi-value.js:697
"Enter field options (one per line)" => array( null, __("Enter field options (one per line)", "forminator" ), ), // src/form/components/settings/multi-value.js:714
"Type or paste options above (one per line and separated by semicolons) or click" => array( null, __("Type or paste options above (one per line and separated by semicolons) or click", "forminator" ), ), // src/form/components/settings/multi-value.js:716
"\"+ Predefined options\"" => array( null, __("\"+ Predefined options\"", "forminator" ), ), // src/form/components/settings/multi-value.js:718
"link to select an option." => array( null, __("link to select an option.", "forminator" ), ), // src/form/components/settings/multi-value.js:720
"Example:" => array( null, __("Example:", "forminator" ), ), // src/form/components/settings/multi-value.js:722
"Import options from CSV" => array( null, __("Import options from CSV", "forminator" ), ), // src/form/components/settings/multi-value.js:731
"Upload file" => array( null, __("Upload file", "forminator" ), ), // src/form/components/settings/multi-value.js:739
"Import" => array( null, __("Import", "forminator" ), ), // src/form/components/settings/multi-value.js:754
"Choose a CSV (.csv) file to import field options and values." => array( null, __("Choose a CSV (.csv) file to import field options and values.", "forminator" ), ), // src/form/components/settings/multi-value.js:762
"Download csv template" => array( null, __("Download csv template", "forminator" ), ), // src/form/components/settings/multi-value.js:765
...
"is having" => array( null, __("is having", "forminator" ), ), // src/utils.js:920
"is" => array( null, __("is", "forminator" ), ), // src/utils.js:923
"is not having" => array( null, __("is not having", "forminator" ), ), // src/utils.js:927
"is not" => array( null, __("is not", "forminator" ), ), // src/utils.js:930
"day is" => array( null, __("day is", "forminator" ), ), // src/utils.js:934
"day is not" => array( null, __("day is not", "forminator" ), ), // src/utils.js:936
"month is not" => array( null, __("month is not", "forminator" ), ), // src/utils.js:938
"month is" => array( null, __("month is", "forminator" ), ), // src/utils.js:940
"is before" => array( null, __("is before", "forminator" ), ), // src/utils.js:942
"is after" => array( null, __("is after", "forminator" ), ), // src/utils.js:944
"is before %s or more days from current date" => array( null, __("is before %s or more days from current date", "forminator" ), ), // src/utils.js:946
"is before less than %s days from current date" => array( null, __("is before less than %s days from current date", "forminator" ), ), // src/utils.js:948
"is after %s or more days from current date" => array( null, __("is after %s or more days from current date", "forminator" ), ), // src/utils.js:950
"is after less than %s days from current date" => array( null, __("is after less than %s days from current date", "forminator" ), ), // src/utils.js:952
"is greater than" => array( null, __("is greater than", "forminator" ), ), // src/utils.js:954
"is less than" => array( null, __("is less than", "forminator" ), ), // src/utils.js:956
"contains" => array( null, __("contains", "forminator" ), ), // src/utils.js:958
"starts with" => array( null, __("starts with", "forminator" ), ), // src/utils.js:960
"ends with" => array( null, __("ends with", "forminator" ), ), // src/utils.js:962
"is correct" => array( null, __("is correct", "forminator" ), ), // src/utils.js:964
"is incorrect" => array( null, __("is incorrect", "forminator" ), ), // src/utils.js:966
"is final result" => array( null, __("is final result", "forminator" ), ), // src/utils.js:969
"is not final result" => array( null, __("is not final result", "forminator" ), ), // src/utils.js:971
"Please fix the error(s) in the SETTINGS tab." => array( null, __("Please fix the error(s) in the SETTINGS tab.", "forminator" ), ), // src/utils.js:1265
"Billing frequency should be greater than or equal to 1" => array( null, __("Billing frequency should be greater than or equal to 1", "forminator" ), ), // src/utils.js:1310
);
